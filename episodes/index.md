...
.home-section { margin-bottom: 40px; line-height: 1.7; }
...
.welcome-text { line-height: 1.7; margin-bottom: 30px; }
...
.videoUpNextWrapper { margin-top: 40px; }
.videoUpNext { display:inline-block; width:49%; margin:auto; padding-bottom: 24% !important; }
</style>
